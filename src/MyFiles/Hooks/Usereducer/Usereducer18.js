                                ...
                                <div key={id} className='col-4 col-xs-12'>
                                    <div className='shadow p-3 mb-3'>
                                        ...
                                        <div className='d-grid gap-0 d-md-flex justify-content-md-end'>
                                            ...
                                            <button className='btn btn-success rounded-0' onClick={()=> navigate(`/Userpost18`)}>Post</button>
                                            <Link className='btn btn-primary rounded-0' to={`/Usereducer18/${eachItem.id}`}>Details</Link>
                                        </div>
                                    </div>
                                </div>
                            )
