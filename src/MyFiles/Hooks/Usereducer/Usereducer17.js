...
const Usereducer17 = () =>{
    ...
    const fetchApi = async (apiUrl)=>{
         ...
         dispatch({type:'ERRORS', payLoad:{status:false, msg:''}});
        try {
            ...
            console.log(error);
            dispatch({type:'LOADING', payLoad:false});
            dispatch({type:'ERRORS', payLoad:{status:true, msg:'something went wrong'}});
        }
    }
        ...
        <div>
            <Header/>
                <div className="container">
                    <h3 className="mt-3 mb-3">Usereducer17 Component</h3>
                                ...
                                <div key={id} className="col-4 col-xs-12">
                                    <div className="shadow p-3 mb-3">
                                        ...
                                        <div className="d-grid gap-0 d-md-flex justify-content-md-end">
                                            ...
                                            <Link className="btn btn-primary rounded-0" to={`/Usereducer17/${eachData.id}`}>Details</Link>
                                        </div>
                                    </div>
                                </div>
                            )
